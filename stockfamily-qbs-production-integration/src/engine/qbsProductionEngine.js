...
h0.open !== null &&
h0.open !== 0 &&
h0.high !== null && h0.low !== null
? ((h0.high - h0.low) / h0.open) * 100
: null;

const bodyPct =
h0.open !== null && h0.open !== 0 && h0.close !== null
? (Math.abs(h0.close - h0.open) / h0.open) * 100
: null;

const upperWickPct =
h0.open !== null && h0.open !== 0 && h0.high !== null && h0.open !== null && h0.close !== null
? ((h0.high - Math.max(h0.open, h0.close)) / h0.open) * 100
: null;

const lowerWickPct =
h0.open !== null && h0.open !== 0 && h0.low !== null && h0.close !== null
? ((Math.min(h0.open, h0.close) - h0.low) / h0.open) * 100
: null;
