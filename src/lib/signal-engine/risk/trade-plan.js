...
exports.buildTradePlan = buildTradePlan;
function buildTradePlan(input) {
    const { close, setup, trigger, support, resistance, recentLow, recentHigh, atr, } = input;
     ...
     */
    const target1 = entry + riskPerShare * 1.50;
    const target2 = entry + riskPerShare * 2.50;
    const riskReward = (target2 - entry) / riskPerShare;
